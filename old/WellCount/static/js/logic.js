...
function createMarkers(response) {
  ...
  for (var index = 0; index < wells.length; index++) {
    ...
    var wellMarker = L.marker([wells.Latitude, wells.Longitude])
      .bindPopup("<h3>" + wells.WellName + "<h3><h3>Operator: " + wells.OperatorName + "</h3>");
...
d3.json("Data/Project3Data.json").then(function(data) {
  console.log(data);
});
